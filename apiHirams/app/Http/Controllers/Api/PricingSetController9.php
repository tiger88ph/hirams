...
class PricingSetController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $pricingSets->each(function ($pricingSet) {
                $pricingSet->sellingPriceTotal = $pricingSet->item_pricings_sum_d_unit_selling_price ?? 0;
                unset($pricingSet->item_pricings_sum_d_unit_selling_price);
            });
    ...
    public function show(int $id): JsonResponse
    {
        try {
            ...
            $pricingSet->sellingPriceTotal = $pricingSet->item_pricings_sum_dunitsellingprice ?? 0;
            unset($pricingSet->item_pricings_sum_dunitsellingprice);
