...
class SupplierController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            // Auto-create matching journal account under "Purchases"
            $purchasesAccount = JournalAccount::where('strAccountName', 'Purchases')
            ...
            if ($purchasesAccount) {
                ...
                $exists = JournalAccount::where('nParentAccountId', $purchasesAccount->nJournalAccountId)
                ...
                if (!$exists) {
                    JournalAccount::create([
                        ...
                        'nParentAccountId' => $purchasesAccount->nJournalAccountId,
                    ]);
                }
            }
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $oldNickname = $supplier->strSupplierNickName ?: $supplier->strSupplierName;

            $supplier->update($validated);
            $supplier->refresh();

            $newNickname = $supplier->strSupplierNickName ?: $supplier->strSupplierName;
            ...
            if ($oldNickname !== $newNickname) {
                ...
                if ($purchasesAccount) {
                    ...
                    $journalAccount = JournalAccount::where('nParentAccountId', $purchasesAccount->nJournalAccountId)
                        ->where('strAccountName', $oldAccountName)
                        ->first();

                    if ($journalAccount) {
                        $clash = JournalAccount::where('nParentAccountId', $purchasesAccount->nJournalAccountId)
