          ...
          <Collapse in={expandedSections.costSummary}>
            <Box sx={{ mb: 1 }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
                  <Typography
                    sx={{ fontSize: "0.72rem", fontWeight: 600, color: "#555" }}
                  >
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          calculations.abcDivePercent >= 0
                            ? "#e8f5e9"
                            : "#fce4ec",
                        border: `1px solid ${calculations.abcDivePercent >= 0 ? "#a5d6a7" : "#f48fb1"}`,
                      }}
                    >
                      <Typography
                        sx={{
                  ...
                  {calculations.totalCost > 0 && (
                    <Box
                      sx={{
                        ...
                        borderRadius: "10px",
                        backgroundColor:
                          calculations.grossProfit >= 0 ? "#e8f5e9" : "#fce4ec",
                        border: `1px solid ${calculations.grossProfit >= 0 ? "#a5d6a7" : "#f48fb1"}`,
                      }}
                    >
                      <Typography
                        sx={{
                      ...
                      >
                        {(
                          (calculations.grossProfit / calculations.totalCost) *
                          100
                        ).toFixed(1)}
                        %
                      </Typography>
