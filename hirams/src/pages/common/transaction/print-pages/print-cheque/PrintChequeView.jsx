export default function PrintChequeView({
  html,
  error,
  loading,
  exporting,
  ...
  if (loading)
    return (
      <div className="print-center">
        ...
        <p className="print-loading-label">Preparing cheque…</p>
    ...
    return (
      <div className="print-center">
        <div className="print-error-card">
          ...
          <button className="print-error-btn" onClick={() => window.close()}>
            Close Window
          </button>
        </div>
      </div>
  ...
  return (
    <>
      <div className="print-top-bar">
        <div className="print-top-inner">
          <div className="print-top-left">
            ...
            <div>
              <div className="print-top-title">Cheque Preview</div>
              <div className="print-top-sub">
      ...
      <div className="print-bar">
        <button className="print-close" onClick={() => window.close()}>
          ✕ Close
        </button>
        ...
        <div className="print-divider" />
        <button
          className="print-btn print-btn-export"
