  ...
  if (loading)
    return (
      <div className="print-center">
        ...
        <p className="print-loading-label">Preparing sales invoice…</p>
      ...
      <div className="print-top-bar">
        <div className="print-top-inner">
          <div className="print-top-left">
            ...
            <div>
              <div className="print-top-title">Sales Invoice Preview</div>
              <div className="print-top-sub">Showing columns A–I · Template rendered from SITemplate.xlsx</div>
            </div>
          </div>
