...
export default function PrintVoucherView({
  ...
  if (loading)
    return (
      <div className="print-center">
        ...
        <p className="print-loading-label">Preparing disbursement voucher…</p>
      ...
      <div className="print-top-bar">
        <div className="print-top-inner">
          <div className="print-top-left">
            ...
            <div>
              <div className="print-top-title">Disbursement Voucher Preview</div>
              <div className="print-top-sub">Template rendered from VoucherTemplate.xlsx</div>
            </div>
          </div>
