...
export default function PurchaseCartUpdateView({
  po,
  initialOptionId,
  isLoadingPage,
  poVoucherStatus,
  ...
  const footerRActions = (
    ...
    >
      ...
      {!isArrivedView && transactionObj?.nTransactionId && (
        <BaseButton
  ...
  return (
    <PageLayout
      ...
      subtitle={
        po?.strPurchaseOrderNo
          ? `${cartStatus[selectedStatusCode]} / ${po.strPurchaseOrderNo}`
          : ""
      }
